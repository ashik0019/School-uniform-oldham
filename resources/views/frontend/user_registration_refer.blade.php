                    ...
                    <div class="col-xxl-4 col-xl-5 col-lg-6 col-md-8 mx-auto">
                        <div class="card">
                            ...
                            <div class="px-5 py-3 py-lg-4">
                                <div class="">
                                    <form id="reg-form" class="form-default" role="form" action="{{ route('user.registration.store') }}" method="POST">
                                        @csrf
                                            ...
                                            <div class="col-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group input-group--style-1">
                                                        <input type="text" class="form-control{{ $errors->has('referral_code') ? ' is-invalid' : '' }}" value="{{ $userData->referral_code }}"  name="referral_code" readonly>
                                                        <span class="input-group-addon">
                                                                <span class="text-md la la-users pt-icon"></span>
                                                            </span>
                                                    </div>
                                                </div>
                                            </div>
