...
@if(!isset($detailedProduct) && !isset($shop) && !isset($page))
    ...
    <meta name="google-site-verification" content="aMGr6hqca9Ubie_N4wiuDhd-uO251QXJorUL9rZHqQM" />
@endif
...
<script>
    ...
    function referFun() {
        ...
        Swal.fire({
            position: 'top-start',
            title: 'Referal Link Successfully Coped!',
            showConfirmButton: false,
            timer: 1500
        })
    }
    function referFun2() {
        /*console.log('ok')*/
        var copyText = document.getElementById("referInput2");
        copyText.select();
        copyText.setSelectionRange(0, 99999);
        document.execCommand("copy");
