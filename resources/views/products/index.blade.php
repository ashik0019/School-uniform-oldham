...
<div class="panel">
    ...
    <div class="panel-heading bord-btm clearfix pad-all h-100">
        <h3 class="panel-title pull-left pad-no">{{ translate($type.' Products') }} <span class="badge badge-danger">{{$products->count()}}</span></h3>
            ...
            <form class="" id="sort_products" action="" method="GET">
                ...
                <div class="box-inline pad-rgt pull-left">
                    <div class="select" style="min-width: 300px;">
                        <select name="pagination" id="pagination" class="form-control demo-select2" onchange="sort_products()">
                            ...
                            <option  {{$allPagination === $products->count() ? 'selected' : ''}} value="{{$allPagination}}">All</option>
                        </select>
                    </div>
                    <div class="select" style="min-width: 200px;">
