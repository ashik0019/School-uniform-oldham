...
class CheckoutController extends Controller
{
        ...
        if ($request->payment_option != null) {
            ...
            if ($request->session()->get('order_id') != null) {
                if ($request->payment_option == 'paypal') {
                    ...
                    $request->session()->forget('delivery_charge');
    ...
    public function store_delivery_charge($d_change)
    {
        Session::put('delivery_charge', $d_change);
        $subtotal = 0;
        $tax = 0;
        $shipping = 0;
        foreach (Session::get('cart') as $key => $cartItem) {
        ...
        return response()->json(['delivery_charge' => $d_change, 'total_price'=>$total+$d_change]);
    }
}
