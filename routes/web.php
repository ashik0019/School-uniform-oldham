...
Route::get('/users/account-delete-request', 'HomeController@accountDeleteReq')->name('user.account-delete-req');
Route::post('/users/account-delete-request-store', 'HomeController@accountDeleteStore')->name('user.delete-account-store');
Route::get('/users/registration', 'HomeController@registration')->name('user.registration');
Route::post('/users/registration-store', 'HomeController@registrationStore')->name('user.registration.store');
Route::get('/get-verification-code/{id}', 'HomeController@getVerificationCode')->name('get-verification-code');
Route::post('/get-verification-code-store', 'HomeController@verification')->name('get-verification-code-store');
//forget password
Route::get('/reset/password', 'ForgotPasswordController@resetPass')->name('reset.pass');
Route::post('/reset/password/phone-check', 'ForgotPasswordController@phoneCheck')->name('reset.pass.phone-check');
Route::get('/reset/password/otp', 'ForgotPasswordController@otpForm')->name('reset.pass.otp-form');
Route::post('/reset/password/otp-check', 'ForgotPasswordController@otpCheck')->name('reset.pass.otp-check');
Route::get('/reset/password/new-password', 'ForgotPasswordController@newPassForm')->name('reset.pass.newpass-form');
Route::post('/reset/password/new-password-store', 'ForgotPasswordController@newPassStore')->name('reset.pass.newpass-form-store');
Route::get('/refer/{id}', 'HomeController@referGet')->name('refer');
...
Route::group(['middleware' => ['checkout']], function(){
	...
	Route::get('/checkout/set/delivery/charge/{id}', 'CheckoutController@store_delivery_charge')->name('checkout.store_delivery_charge');
});
