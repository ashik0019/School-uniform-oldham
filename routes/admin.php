...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function () {
	...
	Route::post('/subcategories/universal', 'SubCategoryController@updateUniversal')->name('subcategories.universal');
	...
	Route::get('/ashiq/referal-id-create', 'BrandController@refIdCreate')->name('brands.ref.create');

	Route::get('/products/admin', 'ProductController@admin_products')->name('products.admin');
	Route::get('/products/slug/check/{slug}', 'ProductController@slugCheck')->name('products.slug.check');
	Route::post('/products/slug/update', 'ProductController@slugUpdate')->name('products.slug.update');
	...
	Route::post('/orders/actions', 'OrderController@orderActions')->name('orders.actions');
